...
pos[9] = createVector(offSetVX+(0*spaceX),offSetVY + (3.5*spaceY));
pos[10] = createVector(offSetVX+(0*spaceX),offSetVY + (8.25*spaceY));
    ...
    if (tipoCat ==11 ) { //categoría principal
      ...
      fill(colores[n]);
        ...
        var km = int(totales[n])/1000;
          ...
          text(km.toFixed(1) + " " + "km",pos[count].x+offSetX, pos[count].y+offSetY2);
